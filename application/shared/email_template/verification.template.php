              ...
              <tr>
                <td align="center" valign="top" width="100%" style="width: 100%; min-width: 100%;">
                  <table cellpadding="12" border="0" cellspacing="0" width="100%" bgcolor="#ff7a59" style="width: 100%; min-width:100%;">
                    <tbody>
                      <tr>
                        <td align="center" valign="middle" width="100%" style="background: linear-gradient(to right, #ff7a59 0%, #ff8f59 100%); width: 100%; padding: 20px; min-width:100%; color: #ffffff"><img src="https://static.hsappstatic.net/EmailNotificationSharedAssets/ex/hubspot-logo-white.png" alt="HubSpot" width="120" height="35" style="width: 120px; height: 35px; vertical-align: middle; clear: both; width: auto; max-width: 100%;">
                          <span
                    ...
                    <tbody>
                      <tr>
                        <td align="left" valign="top" style="font-size: 16px; padding: 0 50px">
                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="middle" style="padding: 0; ">
                                  ...
                                  <h1 style="font-size: 24px; font-weight: 600; margin: 0; text-align: center">Please confirm your email address <br>{{email}}</h1>
                          ...
                          </table><span style="font-weight: 600"> <i18n-string data-key="account.verifyUserEmailAddress.ifNewSignupText" data-locale-at-render="en-us">Thanks for signing up to {{sitename}}, . We’re happy to have you.</i18n-string> </span>
                          <p style="margin: 0">
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
                                      <tr>
                                        <td align="center" style="border-radius: 3px;" bgcolor="#425b76" width="auto"><a href="{{link}}"
