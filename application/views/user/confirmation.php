            ...
            <div class="card border-grey border-lighten-3 m-0 box-shadow-0 card-account-right height-400 z-depth-2">  
                ...
                <div class="card-content">     
                    ...
                    <div class="card-body">
                        ...
                        <a href="mailto:<?php echo $data['confirm_email'] ?>"><?php echo $data['confirm_email'] ?></a><br><br><br>
                        <button class="waves-effect waves-light btn" id="validate"><div class="lds-ring" style="display:none" id="spinner"><div></div><div></div><div></div><div></div></div>&nbsp;&nbsp;&nbsp;I HAVE CONFIRMED ALREADY</button><hr>
