<div class="card">
    <div class="card-content">
        <div class="head-content">
            <div class="center" style="padding:20px;">
                <div style="width:150px; max-width:100%; margin: 0 auto">
                    <img src="81744546ec70b93f065c7321407215727ea39750f52b909dcb/alipay-logo.png" style="width:100%" draggable="false">
                </div>
                <span style="color:green; font-size:15px">
                    We will send details on how to pay with AliPay to your provided email
                </span>
            </div>
        </div>
        ...
        <div align="center">
            <hr>
            <h3>Already payed via AliPay? Upload Verification</h3>
            <?php
