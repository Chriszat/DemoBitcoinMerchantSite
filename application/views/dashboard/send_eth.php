                ...
                <div class="card-content">
                    ...
                    <div class="card-body" style="user-select:none;padding:10px" id="bt">
                        <div class="btc-content" style="margin:0 auto; width:400px; max-width:100%">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" name="eth_address" id="eth_address" placeholder="Ethereum Address" required="" autofocus="">
                                            <label for="eth_address">Ethereum Address <i class="text-danger">*</i></label>
                                        </fieldset>
                            ...
                            <div>
                                <span><b>Available</b></span> <span class="float-right"><a href="wallet/accounts/btc/">ETH <span id="918238279a7bdaac6a29fbb67f46b55e"><?php echo number_format($data['eth_wallet'], 8); ?></span></span></a>
                            </div><br><br><br>
...
<script type="application/json" id="4ac174730d4143a119037d9fda81c7a9">
    {
        "eth_balance": "<?php echo $data['eth_wallet']; ?>"
    }
</script>
