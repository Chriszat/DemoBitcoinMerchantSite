...
?>
<div class="container">
    <h3 align="center">Withdraw History</h3><br>
    <?php //print_r($data) ?>
    <div class="z-depth-2">
        <div class="tran-content">
            ...
            <div class="content-1">
                ...
                <div class="card-footer">
                    <span>Placed withdraw to <b><?php echo $item['account_no']; ?></b> with name <b><?php echo ucwords($item['account_name']); ?></b> 
                    <span style="color:green"><?php echo strtoupper($item['status']); ?></span>
                </span>
