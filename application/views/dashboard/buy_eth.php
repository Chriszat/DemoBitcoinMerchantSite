                    ...
                    <div class="card-body" style="user-select:none;padding:10px" id="bt">
                        <div class="btc-content" style="margin:0 auto; width:400px; max-width:100%">
                            <form id="Btc_form">
                                <div class="row">
                                    <div class="col-md-4">
                                        <button class="btn" disabled><?php echo $data['type'] ?></button>
                                        <!-- <select class="form-control" id="btc_type">
                              <?php if ($data["x"] == "e") { ?>
                            ...
                            <div class="text-center"><button class="btn" style="width:250px; max-width:100%" id="check_on_eth">Next <span class="fa fa-arrow-right"></span></button><br><br>
                            </div>
