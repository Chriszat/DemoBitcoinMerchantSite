            ...
            <div class="card-content">
                ...
                <div class="card-body" style="user-select:none;padding:10px" id="bt">
                   <div class="btc-content text-center" style="margin:0 auto; width:400px; max-width:100%;">
                      ...
                      <div> <br><br>
                    <p >Sell <b><?php echo $data['type'] ?> <?php echo $data['amount'] ?><br> at <?php echo $data['type'] ?>/<?php echo $data["with"] ?> <?php echo $data["round"] ?></b></p>
                   </div>
                   <hr>

                   <div>
                    <div>
                        <span><b>You sell</b></span>
                        <span class="float-right" ><b><?php echo $data['type'] ?> <?php echo $data['amount'] ?></b></span>
                    </div>
                   ...
                   <div>
                   <div>
                        <span class="" style="margin-left:0"><b>You recieve</b></span>
                        <span class="float-right"><b><?php echo $data['with'] ?> <?php echo $data['recieve'] ?></b></span>
                    </div>
                    </div>
